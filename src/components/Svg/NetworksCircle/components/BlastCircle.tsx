...
const Item: FC<PropsWithChildren<SvgProps>> = (props): ReactElement => {
  return (
    <Svg viewBox="0 0 16 16" {...props} fill="none" stroke="none">
        <g clipPath="url(#clip0_11080_34338)">
          ...
          <path d="M8 0.5C12.1422 0.5 15.5 3.85788 15.5 7.99995C15.5 12.142 12.1422 15.4999 8 15.4999C3.8578 15.4999 0.5 12.142 0.5 7.99995C0.5 3.85788 3.8578 0.5 8 0.5Z" stroke="black" strokeOpacity="0.8"/>
