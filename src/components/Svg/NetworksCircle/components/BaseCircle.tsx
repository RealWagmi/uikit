...
const Item: FC<PropsWithChildren<SvgProps>> = (props): ReactElement => {
    ...
    return (
        <Svg viewBox="0 0 16 16" {...props} fill="none" stroke="none">
            <g clipPath={`url(#${id1})`}>
                <path d="M16 7.99995C16 3.58174 12.4183 0 8 0C3.58165 0 0 3.58174 0 7.99995C0 12.4182 3.58165 15.9999 8 15.9999C12.4183 15.9999 16 12.4182 16 7.99995Z" fill={`url(#${id})`}/>
            ...
            <defs>
                <radialGradient id={id} cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(8 7.99995) rotate(90) scale(7.99995 8)">
