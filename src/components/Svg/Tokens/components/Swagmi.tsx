  ...
  return (
    <Svg viewBox="0 0 32 32" {...props} fill="none" stroke="none">
      <g clipPath={`url(#${id})`}>
        ...
        <path
          d="M19.8081 11.708V15.54L15.8401 11.572L11.8681 15.54V11.872L9.08008 9.40799V18.332V18.524V22.172L15.8401 15.416L22.5961 22.172V18.356V18.332V9.23999L19.8081 11.708Z"
          fill="white"
        />
      </g>
      <defs>
