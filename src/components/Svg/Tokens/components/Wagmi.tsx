  ...
  return (
    <Svg viewBox="0 0 32 32" {...props} fill="none" stroke="none">
      <g clipPath={`url(#${clipId})`}>
        <path
          d="M16 32C24.8363 32 32 24.8363 32 16C32 7.16373 24.8363 0 16 0C7.16373 0 0 7.16373 0 16C0 24.8363 7.16373 32 16 32Z"
          fill={`url(#${gradId})`}
        />
        <path
          d="M16.0001 15.9945L8.42676 9.49335V14.3858L16.0001 20.887L23.5734 14.3858V9.49335L16.0001 15.9945Z"
          fill="white"
        />
      ...
      <defs>
        <linearGradient id={gradId} x1="0" y1="16" x2="32" y2="16" gradientUnits="userSpaceOnUse">
