...
const Token: FC<PropsWithChildren<SvgProps>> = (props): ReactElement => (
  <Svg viewBox="0 0 32 32" {...props} fill="none" stroke="none">
    <g clipPath="url(#clip0_0_3)">
      <path d="M15.9936 31.6032C24.6145 31.6032 31.6032 24.6145 31.6032 15.9936C31.6032 7.37263 24.6145 0.383972 15.9936 0.383972C7.37266 0.383972 0.384003 7.37263 0.384003 15.9936C0.384003 24.6145 7.37266 31.6032 15.9936 31.6032Z" fill="#FF564F"/>
