...
export default function Loader({
  ...
  return (
    <StyledRotatingSVG
      ...
      size={size}
      stroke={stroke ?? theme.colors.lightFrenchBeige}
      {...rest}
    >
      <path
...
export function LoaderV2() {
  ...
  return (
    <StyledRotatingSVG size="16px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <StyledSVG size="16px" viewBox="0 0 16 16" fill={rgba(theme.colors.textDimGray, 0.2)} xmlns="http://www.w3.org/2000/svg">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <StyledSVG size="16px" viewBox="0 0 16 16" fill={theme.colors.lightFrenchBeige} xmlns="http://www.w3.org/2000/svg">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
